...
const Hero = () => {
  return (
    <div className="w-[100vw] pt-[4vh] md:pt-[12vh] h-[85vh] md:h-[100vh] custom-bg" id="hero">
          ...
          <div>
            ...
            <div data-aos="fade-left" data-aos-delay="400">
              <h1 className="xl:text-[50px] lg:text[40px] sm:text-[35px] text-[25px] font-semibold leading-[2.6rem] text-white">
                Hi,I'm <span className="text-green-500">Leonardus</span>
              </h1>
              <TypeWriteEffect />
            </div>
            <p
            ...
            >
              {" "}
              As a committed computer science student at the University of
              Jember, I specialize in data science, analysis, business, and
              machine learning, with successful completion of diverse academic
              projects. Currently focusing on web and mobile app development,
              I'm driven by a passion for continuous learning and personal
              growth toward my career goals.
            </p>
            <div className="mt-[2rem] flex items-center space-x-6">
              ...
              <button
                data-aos="zoom-out"
                data-aos-delay="1600"
                className="before:ease relative h-12 w-40 overflow-hidden bg-red-500 text-white
              ...
              before:bg-blue-700 before:transition-all before:duration-300 hover:text-white hover:shadow-black

    ...
    <div className="bg-gray-900">
      <div>
        <Image
          ...
          width={300}
          height={300}
          className="ocject-cover w-[100%]  h-[100%]"
        />
      </div>
      <div className="p-4">
        ...
        <h1
          className="text-[20px] opacity-85 hover:text-yellow-400 transition-all duration-200 cursor-pointer
        ...
        <div className="flex items-center mt-[2rem] justify-between">
          ...
          <button
            className="text-[15px] hover:text-yellow-500 transition-all duration-150 text-white font-semibold
        underline"
          >
            Read More
          </button>
